    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = start_wasm;
                    return [4 /*yield*/, import("../wasm/pkg/carta_backend_bg")];
                case 1:
...
function setEventListeners() {
    ...
    if (uploadArea) {
        setEventsOnArea(uploadArea);
    }
    else {
        console.log('Upload area not found!');
    }
}
function setEventsOnArea(uploadArea) {
...
var makeArrayOfFilePaths = function (fileList) {
